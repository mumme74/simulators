 ...
 * Each terminal that connects to another via a wire does so logically via this class
 * @extends Net
 */
...
/**
 * Base Component class for all electric components in a schema/wiring diagram
 * @extends ComponentBase
 * @property {number} resistance The resistace of this component
 * @property {number} inductance The inductance of this component
 * @property {number} capacitance The capacitance of this component
 */
...
/**
 * A electric fuse class
 * @extends ElectricComponentBase
 * @property {number} rating The maxcurrent of this fuse
 * @property {boolean} broken If the fuse is broken or not
 */
...
/**
 * A Electric switch class
 * @extends ElectricComponentBase
 * @property {boolean} open If the switch is open
 * @property {boolean} closed If ths switch is closed or not, opposite of open
 */
...
/**
 * A incadecent lamp class
 * @extends ElectricComponentBase
 * @property {boolean} broken If the lamp is broken or not
 */
 ...
 * @extends ElectricComponentBase
 * @property {number} nominalVolt The vlotage this cell holds
 * @property {number} soc The State of charge of this cell
 * @property {number} capacity The Capacity of thie cell
 * @property {number} resistance The internal resistance
 */
 ...
 * A capacitor class
 * @extends ElectricComponentBase
 * @property {boolean} polarized If Capacitor is polarized
 */
 ...
 * A Solenoid class
 * @extends ElectricComponentBase
 * @property {number} inductance The inductance of this solenoid
 */
 ...
 * A Diode class
 * @extends ElectricComponentBase
 * @property {number} maxCurrent The maximum current this diode can take
 * @property {number} voltForward The voltage drop over this diode
 */
 ...
 * A npn or pnp class
 * @extends ElectricComponentBase
 * @property {number} maxCurrent The maximum current this transistor can take
 * @property {number} voltForward The voltagedrop over base emitter
 * @property {number} hfe The current gain this transistor has
 * @property {boolean} isPnp If transistor is a PNP
 */
