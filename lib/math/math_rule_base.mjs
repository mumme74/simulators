...
import { MathEngine, SolveChange, precedence,
...
export class MathRuleBase {
  ...
  _doChange(triggerNode, args, value, leftChild, rightChild) {
    ...
    const newNode = new SolveTreeNode(
      triggerNode.astNode, vlu.type, vlu,
...
class RemoveNotNeededGroups extends MathRuleBase {
  constructor() {
    super(`
...
allMathRules.push(RemoveNotNeededGroups);
