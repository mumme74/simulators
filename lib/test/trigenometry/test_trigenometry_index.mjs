...
import { Circle,
         ...
         Square,
         Rect,
         Arrow } from "../../trigenometry/index.mjs";
...
registerTestSuite("testArrow", ()=>{
  ...
  describe("Test construction", ()=>{
    ...
    it("Should construct with classList", ()=>{
      ...
      expect(shp.line.node.classList).toContain("testClassList");
      expect(shp.pnt1Arrow.node.classList).toContain("testClassList");
      expect(shp.pnt2Arrow.node.classList).toContain("testClassList");
      expect(shp.size.width).toBe(10.5,0);
      expect(shp.size.height).toBe(20);
    });
