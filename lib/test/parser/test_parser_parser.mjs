...
registerTestSuite("test Parser, grammar", ()=>{
  describe("test Grammar to AST", ()=>{
    it("Should construct a CST parser from grammar", ()=>{
      ...
      expect(root.children[0].children[0]).toBe('123');
      expect(root.children[0].children[1]).toBe(';');
    });
  });
});
